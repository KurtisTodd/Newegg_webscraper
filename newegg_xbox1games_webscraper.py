...
"""
'''
----------------------- Newegg XBOX ONE discount webscraper ------------------------------------------------------------------
'''
...
'''
newegg_xbox1games_product_list = []
    ...
    for container in containers:
        ...
        if len(price_was_str) > 0 and len(price_current_str) > 0:
            ...
            product_details = {'Title': title, 'Image': image_source, 'Price-was': '$' + price_was_str,
                               ...
                               'Web link': web_link, 'Model number' : model_num, 'Console type' : 'xbox one'}

            newegg_xbox1games_product_list.append(product_details)



for item in newegg_xbox1games_product_list:
    print(item)
