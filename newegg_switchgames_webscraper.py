...
"""
'''
----------------------- Newegg PC discount webscraper ------------------------------------------------------------------
'''

# storing website destination as my_url variable
my_url = 'https://www.newegg.com/p/pl?N=100252381%204803'
...
'''
newegg_switchgames_product_list = []
for num in range(num_of_pages_int):
    ...
    for container in containers:
        ...
        if len(price_was_str) > 0 and len(price_current_str) > 0:
            ...
            newegg_switchgames_product_list.append(product_details)



for item in newegg_switchgames_product_list:
    print(item)
