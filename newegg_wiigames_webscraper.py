...
"""
'''
----------------------- Newegg Wii discount games webscraper ------------------------------------------------------------------
'''

# storing website destination as my_url variable
my_url = 'https://www.newegg.com/Nintendo-Wii-Games/SubCategory/ID-544?Tid=1698973'
...
for num in range(num_of_pages_int):
    ...
    for container in containers:
        ...
        if len(price_was_str) > 0 and len(price_current_str) > 0:
            ...
            newegg_wiigames_list.append(product_details)



for item in newegg_wiigames_list:
    print(item)
