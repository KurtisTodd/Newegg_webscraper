...
"""
'''
----------------------- Newegg Playstation 4 dicount games webscraper ------------------------------------------------------------------
'''

# storing website destination as my_url variable
my_url = 'https://www.newegg.com/p/pl?N=100021831%204803'
...
for num in range(num_of_pages_int):
    ...
    for container in containers:
        ...
        if len(price_was_str) > 0 and len(price_current_str) > 0:
            ...
            newegg_playstation4games_list.append(product_details)



for item in newegg_playstation4games_list:
    print(item)
