...
"""
'''
----------------------- Newegg XBOX X and S discount webscraper ------------------------------------------------------------------
'''

# storing website destination as my_url variable
my_url = 'https://www.newegg.com/Xbox-Series-X-S-Games/SubCategory/ID-3760?Tid=1696837'
...
'''
newegg_xboxgamesx_product_list = []
    ...
    for container in containers:
        ...
        if len(price_was_str) > 0 and len(price_current_str) > 0:
            ...
            product_details = {'Title': title, 'Image': image_source, 'Price-was': '$' + price_was_str,
                               ...
                               'Web link': web_link, 'Model number' : model_num, 'Console type' : 'xbox x/s'}

            newegg_xboxgamesx_product_list.append(product_details)



for item in newegg_xboxgamesx_product_list:
    print(item)
