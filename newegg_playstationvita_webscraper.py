...
"""
'''
----------------------- Newegg Playstation Vita dicount games webscraper ------------------------------------------------------------------
'''

# storing website destination as my_url variable
my_url = 'https://www.newegg.com/PS-Vita-Games/SubCategory/ID-2808?Tid=252386'
...
'''
newegg_playstationvitagames_list = []
for num in range(num_of_pages_int):
    ...
    for container in containers:
        ...
        if len(price_was_str) > 0 and len(price_current_str) > 0:
            ...
            newegg_playstationvitagames_list.append(product_details)



for item in newegg_playstationvitagames_list:
    print(item)
