...
"""
'''
----------------------- Newegg PC discount games webscraper ------------------------------------------------------------------
'''

# storing website destination as my_url variable
my_url = 'https://www.newegg.com/p/pl?N=100007756%204803'
    ...
    for container in containers:
        ...
        if len(price_was_str) > 0 and len(price_current_str) > 0:
            ...
            product_details = {'Title': title, 'Image': image_source, 'Price-was': '$' + price_was_str,
                               ...
                               'Web link': web_link, 'Model number' : model_num, 'Console type' : 'pc'}

            newegg_pcgames_list.append(product_details)



for item in newegg_pcgames_list:
    print(item)
