...
"""
'''
----------------------- Newegg MAC discount games webscraper ------------------------------------------------------------------
'''

# storing website destination as my_url variable
my_url = 'https://www.newegg.com/p/pl?SubCategory=580&N=40000580'
    ...
    for container in containers:
        ...
        if len(price_was_str) > 0 and len(price_current_str) > 0:
            ...
            product_details = {'Title': title, 'Image': image_source, 'Price-was': '$' + price_was_str,
                               ...
                               'Web link': web_link, 'Model number' : model_num, 'Console type' : 'mac'}

            newegg_macgames_list.append(product_details)



for item in newegg_macgames_list:
    print(item)
